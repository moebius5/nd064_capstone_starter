...
_ADSERVICE2 = _descriptor.ServiceDescriptor(
  name='AdService2',
  full_name='hipstershop.AdService2',
  file=DESCRIPTOR,
  index=3,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='GetAds',
    full_name='hipstershop.AdService2.GetAds',
    index=0,
    containing_service=None,
    input_type=_ADREQUEST,
    output_type=_ADRESPONSE,
...
_sym_db.RegisterServiceDescriptor(_ADSERVICE2)

DESCRIPTOR.services_by_name['AdService2'] = _ADSERVICE2
