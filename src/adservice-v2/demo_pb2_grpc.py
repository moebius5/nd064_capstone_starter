...
class AdService2Stub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetAds = channel.unary_unary(
                '/hipstershop.AdService2/GetAds',
                request_serializer=demo__pb2.AdRequest.SerializeToString,
                response_deserializer=demo__pb2.AdResponse.FromString,
                )


class AdService2Servicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_AdService2Servicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetAds': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAds,
                    request_deserializer=demo__pb2.AdRequest.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.AdService2', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class AdService2(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def GetAds(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hipstershop.AdService2/GetAds',
            demo__pb2.AdRequest.SerializeToString,
            demo__pb2.AdResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
